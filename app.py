...
# Function to load or generate .pkl files
def load_or_generate_pkl_file(filename, generate_function):
    if os.path.exists(filename):
        with open(filename, 'rb') as file:
            return pickle.load(file)
    else:
        data = generate_function()  # Generate data if file doesn't exist
        with open(filename, 'wb') as file:
            pickle.dump(data, file)
        return data

def generate_movie_list():
    # Placeholder function to generate movie list (replace with your actual logic)
    movies = {}  # Replace with your movie list generation logic
    return movies

def generate_similarity_matrix():
    # Placeholder function to generate similarity matrix (replace with your actual logic)
    similarity = {}  # Replace with your similarity matrix generation logic
    return similarity
...
movies = load_or_generate_pkl_file('Moviefiles/movie_list.pkl', generate_movie_list)
similiarity = load_or_generate_pkl_file('Moviefiles/similiarity.pkl', generate_similarity_matrix)
